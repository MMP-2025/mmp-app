  ...
  return <Card className="p-6 bg-mental-gray">
      <div className="flex justify-between items-start mb-2">
        ...
        <div className="flex gap-2">
          <Button variant="ghost" size="sm" onClick={() => onToggleSaved(exercise.id)} className="p-1">
            {isSaved ? <BookmarkCheck className="h-6 w-6 text-blue-600" /> : <BookmarkPlus className="h-6 w-6 text-gray-400" />}
          </Button>
          <Button variant="ghost" size="sm" onClick={() => onToggleFavorite(exercise.id)} className="p-1">
