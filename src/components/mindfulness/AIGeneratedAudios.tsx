...
const AIGeneratedAudios: React.FC<AIGeneratedAudiosProps> = ({ onComplete }) => {
  ...
  return (
    <div className="space-y-4">
      {mindfulnessAudios.map(audio => (
        <Card key={audio.id} className="bg-white/90">
          <CardHeader className="pb-3">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <CardTitle className="text-lg mb-2" style={{color: '#737373'}}>
                  {audio.title}
                </CardTitle>
              ...
              <div className="text-sm font-medium" style={{color: '#737373'}}>
