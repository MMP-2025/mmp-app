...
const CBTModules: React.FC = () => {
  ...
  return <div className="space-y-6">
      <Card className="p-6 bg-mental-gray">
        ...
        {!currentModule ? <CBTModuleSelector modules={modules} onSelectModule={setCurrentModule} /> : <CBTSessionWizard module={currentModule} onComplete={addSession} onCancel={() => setCurrentModule(null)} />}
      </Card>
