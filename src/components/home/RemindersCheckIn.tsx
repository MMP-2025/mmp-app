  ...
  return (
    <Card className="p-6 bg-mental-peach/20">
      <div className="flex items-center gap-2 mb-2">
        <Bell className="h-5 w-5 text-[#7e868b]" />
        <h2 className="text-xl font-semibold text-[#7e868b]">Your Reminders</h2>
      </div>
      <p className="mb-4 text-[#7e868b]">Stay on track with personalized reminders.</p>
