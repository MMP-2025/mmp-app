  ...
  const [challenges] = useState<Challenge[]>([
    {
      ...
      completed: false,
      tasks: [
        'Day 1: 10-minute breathing meditation',
        'Day 2: Mindful walking for 15 minutes',
        'Day 3: Body scan meditation',
        'Day 4: Mindful eating exercise',
        'Day 5: Loving-kindness meditation',
        'Day 6: Mindful journaling',
    ...
    },
    {
      ...
      tasks: [
        ...
        'Share weekly reflection',
        'Practice gratitude meditation',
        'Express gratitude to someone each week'
      ]
    },
    {
      id: 'mood_tracking',
    ...
    },
    {
      ...
      completed: false,
      tasks: [
        'Contact 1 person daily',
        'Have meaningful conversations',
        'Plan social activities',
        'Reflect on connection quality'
      ]
    }
  ]);
    ...
    <div className="space-y-6">
      ...
      <Card className="p-6 bg-gradient-to-br from-purple-50 to-blue-50">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-lg font-semibold" style={{color: '#737373'}}>Your Active Challenges</h3>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="text-center">
            ...
            <div className="text-sm" style={{color: '#737373'}}>Active</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-green-600">
              {challenges.filter(c => c.completed).length}
            </div>
            <div className="text-sm" style={{color: '#737373'}}>Completed</div>
          </div>
          <div className="text-center">
            ...
            <div className="text-sm" style={{color: '#737373'}}>Avg Progress</div>
          </div>
        </div>
      </Card>
      ...
      <div className="grid gap-4">
        {filteredChallenges.map(challenge => (
          <Card key={challenge.id} className="p-6 bg-white/90">
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2">
                  <h3 className="text-lg font-semibold" style={{color: '#737373'}}>{challenge.title}</h3>
                  <Badge className={getDifficultyColor(challenge.difficulty)}>
                    {challenge.difficulty}
                  </Badge>
                  {challenge.joined && (
                    <Badge className="bg-blue-100 text-blue-800">Joined</Badge>
                  )}
                  {challenge.completed && (
                ...
                <p className="text-sm mb-3" style={{color: '#737373'}}>{challenge.description}</p>
                ...
                {challenge.joined && challenge.progress !== undefined && (
                  <div className="mb-3">
                    <div className="flex justify-between text-sm mb-1">
                      ...
                      <span style={{color: '#737373'}}>{challenge.progress}%</span>
                    </div>
                ...
                <div className="text-xs" style={{color: '#737373'}}>
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    ...
                    {challenge.tasks.length > 3 && (
                      <li>...and {challenge.tasks.length - 3} more</li>
                    )}
                  </ul>
                </div>
              </div>
