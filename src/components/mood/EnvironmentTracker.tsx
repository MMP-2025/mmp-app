  ...
  return (
    <Card className="p-4 bg-white/90">
      <div className="flex items-center gap-2 mb-3">
        <WeatherIcon className="h-5 w-5" style={{color: '#737373'}} />
        <h3 className="text-lg font-semibold" style={{color: '#737373'}}>Environment</h3>
        <Info className="h-4 w-4" style={{color: '#737373'}} />
      </div>
