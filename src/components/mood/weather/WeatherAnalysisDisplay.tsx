...
const WeatherAnalysisDisplay: React.FC<WeatherAnalysisDisplayProps> = ({ 
    ...
    return (
      <Card className="p-6 bg-white/90">
        <div className="flex items-center gap-3 text-center">
          <AlertCircle className="h-5 w-5" style={{color: '#737373'}} />
          <div>
            <h4 className="text-lg font-semibold mb-2" style={{color: '#737373'}}>
              Not Enough Data
            </h4>
  ...
  return (
    <Card className="p-6 bg-white/90">
      <h4 className="text-lg font-semibold mb-4" style={{color: '#737373'}}>
      ...
      <div className="space-y-3">
        {correlations.map(({ condition, averageMood, count }) => (
          <div key={condition} className="flex justify-between items-center p-3 bg-mental-peach/20 rounded">
            <span className="capitalize font-medium" style={{color: '#737373'}}>
              {condition} Weather
            </span>
