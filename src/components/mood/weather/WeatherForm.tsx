...
const WeatherForm: React.FC<WeatherFormProps> = ({
  ...
  return <Card className="p-6 bg-mental-blue">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        <WeatherConditionSelector weather={currentWeather} onWeatherChange={setCurrentWeather} />
        ...
        <div>
          ...
          <Input type="number" value={currentWeather.temperature} onChange={e => setCurrentWeather({
          ...currentWeather,
        ...
        <div>
          ...
          <Input type="number" value={currentWeather.humidity} onChange={e => setCurrentWeather({
          ...currentWeather,
        ...
        <div>
          ...
          <Input value={currentWeather.location} onChange={e => setCurrentWeather({
          ...currentWeather,
