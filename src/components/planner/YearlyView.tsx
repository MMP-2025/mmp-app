      ...
      <div className="grid grid-cols-3 gap-4">
        {months.map((month, index) => {
          ...
          return (
            ...
            >
              <h4 className={`text-center mb-2 text-gray-800 ${isCurrentMonth ? 'font-bold' : ''}`}>
                {format(month, 'MMMM')}
              </h4>
              ...
              <div className="text-sm">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-medium text-gray-800">{monthEvents.length}</span>
                </div>
                
                {monthEvents.length > 0 && (
                  <div className="mt-2 text-xs space-y-1">
                    <div className="font-medium text-gray-800">Top days:</div>
