  ...
  return <div className="space-y-6 max-w-6xl mx-auto">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p style={{
          color: '#737373'
        }}>Organize your schedule and plan your activities</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-3 pt-4 border-t bg-mental-peach">
              ...
              <div className="space-y-2">
                <Input placeholder="Event title" value={newEventTitle} onChange={e => setNewEventTitle(e.target.value)} className="text-sm" style={{
                color: '#737373'
              }} />
              </div>
              <div className="space-y-2">
                <div className="flex items-center space-x-2">
                  ...
                  <Input type="time" value={newEventTime} onChange={e => setNewEventTime(e.target.value)} className="text-sm" style={{
                  color: '#737373'
                }} />
                </div>
              </div>
        ...
        <Card className="lg:col-span-3">
          <CardHeader className="bg-mental-peach">
            <CardTitle className="text-lg" style={{
            color: '#737373'
          }}>Schedule Views</CardTitle>
          </CardHeader>
          <CardContent className="bg-mental-peach">
            <Tabs defaultValue="day" className="w-full">
              <TabsList className="grid w-full grid-cols-4 bg-mental-gray">
                <TabsTrigger value="day" style={{
                color: '#737373'
              }}>Day</TabsTrigger>
                <TabsTrigger value="week" style={{
                color: '#737373'
              }}>Week</TabsTrigger>
                <TabsTrigger value="month" style={{
                color: '#737373'
              }}>Month</TabsTrigger>
                <TabsTrigger value="year" style={{
                color: '#737373'
              }}>Year</TabsTrigger>
              </TabsList>
