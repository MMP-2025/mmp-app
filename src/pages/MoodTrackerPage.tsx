    ...
    <div className="bg-mental-blue min-h-screen">
      <SidebarLayout>
        <div className="space-y-6 max-w-4xl mx-auto">
                ...
                <button 
                  ...
                  className={`p-4 rounded-md transition-all flex flex-col items-center gap-2 ${
                    selectedMood === mood.name 
                      ? 'bg-mental-peach border-2 border-foreground' 
                      : 'hover:bg-mental-peach/40'
                  }`}
                >
                  <mood.icon className="h-8 w-8 text-foreground" />
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Textarea 
                    ...
                    className="min-h-[120px] border-border focus:border-ring text-foreground" 
                  />
                </div>
                <Button 
          ...
          <Card className="p-6 bg-white/90">
            <h2 className="text-xl font-semibold mb-4 text-foreground">Your Mood History</h2>
